  ...
  return (
      <div className="application">
          <Helmet>
              ...
              <meta property="og:image" content={product?.defaultImage ? product?.defaultImage : <DesiCartIcon />} />
              <meta property="image" content={product?.defaultImage ? product?.defaultImage : 'default-image-url'} />
              <img src={product?.defaultImage ? product?.defaultImage : 'default-image-url'} />
